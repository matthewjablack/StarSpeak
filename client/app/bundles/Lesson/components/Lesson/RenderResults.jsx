    ...
    return (
      <div className="bgWhite">
        <div className="container">
          ...
          <br/>
          <Stats stage={this.props.stage} indico={this.props.indico} watson={this.props.watson} user={this.props.user} screenshot={this.props.screenshot[this.props.screenshot.length -1]}/>
          {this.props.children}
          <br/><br/>
