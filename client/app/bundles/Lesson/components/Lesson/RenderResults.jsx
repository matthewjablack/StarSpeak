    ...
    return (
      <div className="bgWhite">
        <div className="container">
          ...
          <br/>
          <Stats stage={this.props.stage} indico={this.props.indico} watson={this.props.watson} user={this.props.user} speechstat={this.props.speechstat} screenshot={this.props.screenshot} local={this.props.local} />
          {this.props.children}
          <br/><br/>
