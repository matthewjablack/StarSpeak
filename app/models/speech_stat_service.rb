class SpeechStatService
    ...
    facial_stat_all = []
    facial_appearance_stat_all = []
    facial_emotion_stat_all = []
    facial_expression_stat_all = []
    facial_emoji_stat_all = []
      ...
      facial_appearance_stat_all << facial_appearance_stat
      ...
      facial_emotion_stat_all << facial_emotion_stat
      ...
      facial_expression_stat_all << facial_expression_stat
      ...
      facial_emoji_stat_all << facial_emoji_stat

    end

    FacialStat.import facial_stat_all
    FacialAppearanceStat.import facial_appearance_stat_all
    FacialEmotionStat.import facial_emotion_stat_all
    FacialExpressionStat.import facial_expression_stat_all
    FacialEmojiStat.import facial_emoji_stat_all
	end
end